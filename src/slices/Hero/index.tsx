    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 items-center min-h-[70vh]">
        <div className="col-start-1 md:row-start-1">
          ...
          <span className="job-title opacity-0 block bg-gradient-to-tr dark:from-gray-400 dark:via-gray-200 dark:to-gray-400 from-gray-700 via-gray-500 to-gray-700 bg-clip-text text-2xl font-bold uppercase tracking-[.2em] text-transparent md:text-4xl">
